mich_vector <- function(y, fit_intercept, fit_scale,
                        ...
                        restart, n_restart, n_search, reverse,
  ...
  while (TRUE) {
    ...
    if (no_merges) break
    if (merge_message & verbose & !any(J_auto, K_auto, L_auto)) print("Merging duplicate components")
    merge_message <- FALSE
